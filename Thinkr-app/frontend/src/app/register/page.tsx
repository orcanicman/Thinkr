  ...
  return (
    <main className="flex min-h-screen flex-col sm:items-center sm:p-0 p-6">
      ...
      <form className="flex flex-col sm:w-96 sm:items-center">
        <h1 className="font-bold sm:text-7xl text-4xl sm:my-12 my-6">
          Register
        </h1>
        ...
        <Link
          href={"login"}
          className="text-ownGreen underline my-4 self-start"
        >
          Already have an account?
        </Link>
      </form>

      <footer className="overflow-hidden absolute bottom-0 w-screen sm:h-24 lg:h-60 -z-10">
        <Image
          alt="LOL2"
